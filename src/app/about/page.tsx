    ...
    <div className="bg-orange-50">
      ...
      >
        ...
        <div
          ...
          className="lg:py-20 xl:py-32 md:py-16 px-4 flex flex-col space-y-2 lg:space-y-3 xl:space-y-3 md:space-y-3 items-center justify-center"
        >
      ...
      <div className="lg:mx-24 xl:mx-24 md:mx-24 mx-4 text-lg">
        ...
        <div className="text-brown py-10 mb-5">
          <h1 className="text-center mb-5 text-5xl font-extrabold">
        ...
        <div className="text-brown grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-5 py-10">
          <div>
            <h1 className="text-5xl mb-5 font-extrabold">From Field to Fork</h1>
            <p>
      ...
      <div className="py-10">
        <h1 className="text-5xl text-brown text-center font-extrabold">
          Our Baking Maestros
        </h1>
        <div className="grid gap-4 lg:grid-cols-4 md:grid-cols-4 grid-cols-1 xl:grid-cols-4 lg:mx-24 xl:mx-24 md:mx-24 mx-4 py-5">
          ...
          <ProfileCard
            ...
            description="Thomas's passion lies in the art of bread-making. As our artisan bread specialist, he expertly crafts a wide variety of bread, from crusty sourdough to flavorful whole grain loaves, using traditional techniques and carefully selected ingredients"
          />
          <ProfileCard
